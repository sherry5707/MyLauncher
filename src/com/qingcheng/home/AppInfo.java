...
public class AppInfo extends ItemInfo {
    ...
    public String fakeIcon;

    boolean updateLunchShortcut;
    ...
    public boolean equals(Object obj) {
        try {
            ...
            if (temp.intent != null && this.intent != null) {
                if (temp.intent.getComponent() != null && this.intent.getComponent() != null) {
                    if (temp.intent.getComponent().equals(this.intent.getComponent())) {
                        return true;
                    }
                }
            }
        } catch (Exception e) {
            Log.e(TAG, "appinfo equals: " + e.toString());
        }
        return false;
    }
