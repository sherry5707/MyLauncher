...
public class AppWidgetResizeFrame extends FrameLayout {
    ...
    public void snapToWidget(boolean animate) {
        ...
        int newWidth = (int)(mWidgetView.getWidth()*(Workspace.getmNewScaleForWidgetResize()!=-1? Workspace.getmNewScaleForWidgetResize():1)) 
        		+ 2 * mBackgroundPadding - mWidgetPaddingLeft - mWidgetPaddingRight;
        int newHeight = (int)(mWidgetView.getHeight()*(Workspace.getmNewScaleForWidgetResize()!=-1? Workspace.getmNewScaleForWidgetResize():1)) 
        		+ 2 * mBackgroundPadding - mWidgetPaddingTop - mWidgetPaddingBottom;
    	...
    	boolean containNeedMethod = false;
    	try {
			Class<?> a = Class.forName("com.qingcheng.home.DragLayer$LayoutParams");
			Method[] bb = a.getDeclaredMethods();
			for (int i = 0; i < bb.length; i++) {
				QCLog.d("remy", ""+bb[i]);
			}
			Method b = a.getMethod("setX", int.class);
			if (b!=null) {
				containNeedMethod = true;
			}
		} catch (Exception e) {
