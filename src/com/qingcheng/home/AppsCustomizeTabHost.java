...
public class AppsCustomizeTabHost extends FrameLayout implements LauncherTransitionable, Insettable  {
    ...
    public void onLauncherTransitionEnd(Launcher l, boolean animated, boolean toWorkspace) {
        Trace.beginSection("AppsCustomizeTabHost.onLauncherTransitionEnd");
        if (!toWorkspace) {
            if (LauncherLog.DEBUG) {
        ...
        Trace.endSection();
        Trace.beginSection("AppUpdate_1");
        mPagedView.onLauncherTransitionEnd(l, animated, toWorkspace);
        mInTransition = false;
        Trace.endSection();

        Trace.beginSection("AppUpdate_0");
    ...
    //M:[OP09] Support edit/hide app. start @{
    /**
