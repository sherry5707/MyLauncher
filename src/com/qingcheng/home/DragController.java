...
public class DragController {
    ...
    private static final float MAX_FLING_DEGREES = 20f;//35f;
    ...
    private DropTarget findDropTarget(int x, int y, int[] dropCoordinates) {
        ...
        for (int i=count-1; i>=0; i--) {
            ...
            if ((mDragObject.y>lastY) && (mDragObject.y>(LauncherApplication.getScreenHeightPixel()-LauncherApplication.navBarHeight))) {
				mDragObject.y = lastY;
			}
            if (r.contains(x, mDragObject.y)) {
