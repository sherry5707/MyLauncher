...
public class DragView extends View {
    ...
    public DragView(Launcher launcher, Bitmap bitmap, int registrationX, int registrationY,
        ...
        if (QCLog.DEBUG) {
			QCLog.d(TAG, "DragView() and setScaleX("+initialScale+")");
		}
        ...
        mAnim.addUpdateListener(new AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                mOffsetY += deltaY;
                if (QCLog.DEBUG) {
					QCLog.d(TAG, "DragView() AnimatorUpdateListener onAnimationUpdate() and setScaleX("+(initialScale + (value * (scale - initialScale)))+")");
				}
    ...
    void move(int touchX, int touchY) {
        ...
        Trace.beginSection("posX");
        Trace.endSection();
        Trace.beginSection("posY");
        Trace.endSection();
        Trace.beginSection("move");
        /// M: @}
