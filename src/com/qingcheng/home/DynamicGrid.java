...
public class DynamicGrid {
    ...
    public DynamicGrid(Context context, Resources resources,
        ...
        deviceProfiles.add(new DeviceProfile("Nexus S",
                296, 491.33f,  4, 4,  48, 13, (hasAA ? 5 : 4), 48, R.xml.default_workspace_4x4,
                R.xml.default_workspace_4x4_no_all_apps));
        ...
        deviceProfiles.add(new DeviceProfile("Nexus 4",
                335, 567,  5, 4,  DEFAULT_ICON_SIZE_DP, 12, (hasAA ? 5 : 4), DEFAULT_ICON_SIZE_DP, R.xml.default_workspace_5x4,
                R.xml.default_workspace_5x4_no_all_apps));
        deviceProfiles.add(new DeviceProfile("Nexus 5",
                359, 567,  4, 4,  DEFAULT_ICON_SIZE_DP, 13, (hasAA ? 5 : 5), DEFAULT_ICON_SIZE_DP, R.xml.default_workspace_4x4,
                R.xml.default_workspace_4x4_no_all_apps));
