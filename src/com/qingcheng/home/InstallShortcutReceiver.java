...
public class InstallShortcutReceiver extends BroadcastReceiver {
    ...
    static void flushInstallQueue(Context context) {
		 ...
		 */
    	 if(QCLog.DEBUG){
         	QCLog.i("ItemInfo", " flushInstallQueue " ,true);
         }
        ...
        if (!installQueue.isEmpty()) {
            ...
            while (iter.hasNext()) {
                ...
                final boolean exists = needCheck && LauncherModel.shortcutExists(context, name, intent);
                ...
                if (packageName != null && !packageName.isEmpty()) {
                    ...
                    if (needCheck && !LauncherModel.isValidPackage(context, packageName, myUserHandle)) {
                        if (DBG) Log.d(TAG, "Ignoring shortcut for absent package:" + intent);
                        continue;
                    }

                    if(/*!"com.tencent.mobileqq".equals(packageName) &&*/ !"com.tencent.mm".equals(packageName) && !"com.vapp.aide.intl".equals(packageName)
