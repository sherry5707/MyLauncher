...
public class LauncherScroller  {
	private final String TAG = "LauncherScroller";
    private int mMode;
    ...
    public LauncherScroller(Context context, Interpolator interpolator, boolean flywheel) {
    	if (QCLog.DEBUG) {
			QCLog.d(TAG, "LauncherScroller() true");
		}
        mFinished = true;
        mInterpolator = interpolator;
    ...
    public final void forceFinished(boolean finished) {
    	if (QCLog.DEBUG) {
			QCLog.d(TAG, "forceFinished() finished = "+finished);
		}
        mFinished = finished;
    }
    ...
    public boolean computeScrollOffset() {
    	if (QCLog.DEBUG) {
			QCLog.d(TAG, "computeScrollOffset() and mFinished = "+mFinished);
		}
        if (mFinished) {
            return false;
        }
        ...
        if (timePassed < mDuration) {
            ...
            case FLING_MODE:
                ...
                if (mCurrX == mFinalX && mCurrY == mFinalY) {
                	if (QCLog.DEBUG) {
            			QCLog.d(TAG, "computeScrollOffset() true");
            		}
                    mFinished = true;
                }
    ...
    public void abortAnimation() {
    	if (QCLog.DEBUG) {
			QCLog.d(TAG, "abortAnimation() true");
		}
        mCurrX = mFinalX;
        mCurrY = mFinalY;
        mFinished = true;
    ...
    public void extendDuration(int extend) {
    	if (QCLog.DEBUG) {
			QCLog.d(TAG, "extendDuration() false");
		}
