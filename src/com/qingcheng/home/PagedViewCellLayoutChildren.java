...
public class PagedViewCellLayoutChildren extends ViewGroup {
    ...
    /**
     * M: Set layout params for the current cell layout.
     *
     * @param lp The layout params.
     */
    public void setupLp(PagedViewCellLayout.LayoutParams lp) {
        lp.setup(null, mCellWidth, mCellHeight, mWidthGap, mHeightGap, getPaddingLeft(), getPaddingTop());
    }

    /**
     * M: Get child at the given cell X and cell Y.
     *
     * @param x
     * @param y
     * @return
