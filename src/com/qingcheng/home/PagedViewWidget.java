...
public class PagedViewWidget extends LinearLayout {
    ...
    public int[] getPreviewSize() {
        ...
        maxSize[1] = i.getHeight() - mOriginalImagePadding.top - mOriginalImagePadding.bottom;
    ...
    void applyPreview(FastBitmapDrawable preview, int index) {
        ...
        if (preview != null) {
            ...
            if (mIsAppWidget) {
                ...
                int widthPadding = (imageSize[0]-preview.getIntrinsicWidth())/2;
                int heightPadding = (imageSize[1]-preview.getIntrinsicHeight())/2;
                ...
                image.setPadding(mOriginalImagePadding.left + centerAmount,
                        mOriginalImagePadding.top+heightPadding,
                        mOriginalImagePadding.right,
                        mOriginalImagePadding.bottom);
            }
            image.setAlpha(1f);
