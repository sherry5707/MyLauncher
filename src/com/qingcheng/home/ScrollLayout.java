/**
sunfeng add for folder @20150802 
...
public class ScrollLayout extends ViewGroup {
	...
	//sunfeng modify @20150809 start:  300 --- 350
    protected static final int PAGE_SNAP_ANIMATION_DURATION = 330;
	//sunfeng modify @20150809 end:  300 --- 350
	...
	public void snapToScreen(int whichScreen) {
		...
		if (getScrollX() != (whichScreen * getWidth())) {
    		...
    		//sunfeng modify @20150809 start:
			mScroller.startScroll(getScrollX(), 0, delta, 0,
					PAGE_SNAP_ANIMATION_DURATION/* 300 --- 350 Math.abs(delta) * 2*/);
    		//sunfeng modify @20150809 end:
...
//		}
	...
	Folder mPageIndicator;
	public void setPageIndicator(Folder pageIndicator){
		mPageIndicator = pageIndicator;
	}
	
	private void setActiveMarker(){
		if(mPageIndicator != null){
			mPageIndicator.ShowPageNumber(this.getChildCount(), mCurScreen);
		}
