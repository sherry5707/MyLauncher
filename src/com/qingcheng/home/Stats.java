...
public class Stats {
	...
	private static boolean IS_USER_BUILD = true;
    ...
    public Stats(Launcher launcher) {
        ...
        try {
			...
			if (systemProperty!=null) {
				Method get = systemProperty.getMethod("get", String.class);
				String buildType = (String)get.invoke(systemProperty, "ro.build.type");
				IS_USER_BUILD = !(buildType.equals("eng"));
			}
		} catch (Exception e) {
