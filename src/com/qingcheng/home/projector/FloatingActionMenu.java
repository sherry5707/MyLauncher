...
import com.qingcheng.home.projector.animation.DefaultAnimationHandler;
import com.qingcheng.home.projector.animation.MenuAnimationHandler;
...
public class FloatingActionMenu {
    ...
    private static final int RADIUS_PORT_0_4 = 561;
    private static final int RADIUS_PORT_2 = 474;
    private static final int RADIUS_PORT_1_3 = 486;
    ...
    private SubActionButton subMenuButtonV;
    ...
    public FloatingActionMenu(final View mainActionView,
                              ...
                              final boolean systemOverlay, final View parentView, SubActionButton subMenuButton, SubActionButton subMenuButtonG, SubActionButton subMenuButtonV) {
        ...
        this.subMenuButtonV = subMenuButtonV;
...
//        launcher.updateSubGalleryContent();
    ...
    public void extendClose(boolean animated) {
        if(open) {
            ...
            subMenuButtonV.close();
            mainParentView.postDelayed(new Runnable() {
                @Override
                public void run() {
                    close(animated);
                }
...
//            return ((Activity) mainActionView.getContext()).getWindow().getDecorView().findViewById(android.R.id.content);
    ...
    public SubActionButton getSubMenuButtonV() {
        return subMenuButtonV;
    }
    ...
    public static class Builder {
        ...
        public Builder addSubMenuV(SubActionButton subMenuButton) {
            this.subMenuButtonV = subMenuButton;
            return this;
        }
