...
package com.qingcheng.home.wallpaper.photos;
...
// Modify for independent apk Jing.Wu 20161124 start
//import com.mediatek.dcfdecoder.DcfDecoder;
import com.qingcheng.home.wallpaper.util.DcfDecoder;
// Modify for independent apk Jing.Wu 20161124 end
import com.qingcheng.home.wallpaper.gallery3d.common.BitmapUtils;
...
import com.qingcheng.home.wallpaper.gallery3d.glrenderer.BasicTexture;
import com.qingcheng.home.wallpaper.gallery3d.glrenderer.BitmapTexture;
import com.qingcheng.home.wallpaper.photos.views.TiledImageRenderer;
...
/**
 * A {@link com.qingcheng.home.wallpaper.photos.views.TiledImageRenderer.TileSource} using
...
public class BitmapRegionTileSource implements TiledImageRenderer.TileSource {
    ...
    public static byte[] forceDecryptFile(String filePath, boolean consume) {
        ...
        // Modify for independent apk Jing.Wu 20161124 start
        try {
        	Class dcfDecoder = Class.forName("com.mediatek.dcfdecoder.DcfDecoder");
        	if (dcfDecoder!=null) {
				Method forceDecryptFile = dcfDecoder.getMethod("forceDecryptFile", String.class, boolean.class);
				byte[] result = (byte[])forceDecryptFile.invoke(dcfDecoder, filePath, consume);
				if (result!=null) {
					return result;
				}
			}
